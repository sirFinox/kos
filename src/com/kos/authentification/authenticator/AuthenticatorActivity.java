...
package com.kos.authentification.authenticator;
...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    private boolean acExists=false;
    ...
    public void onCreate(Bundle icicle) {
        ...
        String S=null;
        for(Account ac:a){
        	if(ac.type.contains(Constants.ACCOUNT_TYPE)){
        		acExists=true;
        		mUsername=ac.name;
        		mPassword=mAccountManager.getPassword(ac);
        		showProgress();
                mAuthTask = new UserLoginTask();
                mAuthTask.execute();
                super.getIntent().putExtra("mUsername", mUsername);
                File f = new File(getCacheDir(), "username.dat");
                Log.i("Cache DIR", getCacheDir().getAbsolutePath());
                try {
					if (!f.isFile()){
						File.createTempFile("username", ".dat", getCacheDir());
					}
                ...
                SqlConnector sql = SqlConnector.getInstance(AuthenticatorActivity.this);
				sql.saveUsername(mUsername,AuthenticatorActivity.this);
				MainActivity.setOnline();
                //GetKosDataActivity.setUsername(mUsername);
                //SyncCalActivity.setUsername(mUsername);
	...
	public void onSaveInstanceState(Bundle outState) {
		super.onSaveInstanceState(outState);
			getFragmentManager().putFragment(outState, "mContent",
					mContent);
	}
